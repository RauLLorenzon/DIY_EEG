...
//321934/1493268/2.50/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP1754ST-3302E_DB" (originalName "MCP1754ST-3302E_DB")
	...
	(compDef "MCP1754ST-3302E_DB" (originalName "MCP1754ST-3302E_DB") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP1754ST-3302E_DB"))
		...
		(attr "Mouser Part Number" "579-MCP1754T-3302EDB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP1754ST-3302E-DB?qs=geWWqIMx8Ypn%2FSBmGzIfBw%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP1754ST-3302E/DB")
		(attr "Description" "LDO Voltage Regulators LDO")
		(attr "<Hyperlink>" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en555395")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "MCP1754ST-3302E_DB.stp")
